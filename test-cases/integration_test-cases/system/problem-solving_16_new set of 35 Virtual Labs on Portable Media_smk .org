...
* Post conditions
   - Nil
* Test Steps
  1. Click on the new set of 35 Virtual Labs on Portable Media link 
  2. It should re-direct to the new set of 35 Virtual Labs on Portable Media page

* Expected result
  1. New set of 35 Virtual Labs on Portable Media page should be opened
